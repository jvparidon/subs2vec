...
def fit_model():
    ...
    with pm.Model() as beta_model:
        ...
        trace = pm.sample(4000, tune=2000, chains=3, target_accept=.95)

    # store trace summary as tsv and LaTeX table
    df_summary = pm.summary(trace, credible_interval=.9)
    df_summary.to_csv('trace_summary.tsv')
    ...
    axes = pm.forestplot(trace, var_names=varnames, credible_interval=.9, figsize=(4.5, 3))
