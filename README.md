...
The scripts in this repository require [Python 3.7](https://www.python.org/downloads/) and some libraries that are easily installed through pip. (If you want to use the `sub2vec.py` script to train your own word embeddings, you will also need compiled fastText and word2vec binaries.)  
